...
function onCurrentPositionGotten(position) {
  ...
  var markersParam1 = "&markers=icon:http://i.imgur.com/4CNJyMd.png%7Cshadow:true%7Cw+40th+street+and+Avenue+of+Americas"
  var markersParam2 = "&markers=icon:http://i.imgur.com/JAJeqZS.png%7Cshadow:true%7Cw+40th+street+and+5th+Avenue"
  var markersParam3 = "&markers=icon:http://i.imgur.com/Fe0smJE.png%7Cshadow:true%7Cw+W+42nd+street+and+5th+Avenue"

  var fullUrl = baseUrl + sizeParam + centerParam + zoomParam + markersParam1 + markersParam2 + markersParam3;
  console.log(fullUrl);
